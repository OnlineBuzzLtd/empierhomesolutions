...
const STAFF = [
  {
    email: "admin@empirehomesolutions.local",
    fullName: "Empire CRM Admin",
    role: "admin",
    phone: "0208 555 0101",
    agreedHours: "Mon-Fri 08:00-18:00",
    payType: "salary",
  },
  {
    email: "engineer@ehs.local",
    fullName: "Empire Field Engineer",
    role: "engineer",
    phone: "07700 300 101",
    agreedHours: "Mon-Fri 08:00-17:30",
    payType: "salary",
  ...
  {
    email: "ops@empirehomesolutions.local",
    fullName: "Claire Sutton",
    role: "management",
    phone: "07700 300 102",
    agreedHours: "Mon-Fri 07:30-17:30",
    payType: "salary",
  },
  {
    email: "sales@empirehomesolutions.local",
    fullName: "Ben Carter",
    role: "sales",
    phone: "07700 300 103",
    agreedHours: "Mon-Fri 09:00-18:00",
    payType: "salary",
  },
  {
    email: "accounts@empirehomesolutions.local",
    fullName: "Maria Ahmed",
    role: "accounts",
    phone: "07700 300 104",
    agreedHours: "Mon-Fri 09:00-17:30",
    payType: "salary",
  },
  {
    email: "luke.bennett@empirehomesolutions.local",
    fullName: "Luke Bennett",
    role: "engineer",
    phone: "07700 300 105",
    agreedHours: "Mon-Sat 07:30-16:30",
    payType: "day-rate",
  },
  {
    email: "amina.rahman@empirehomesolutions.local",
    fullName: "Amina Rahman",
    role: "engineer",
    phone: "07700 300 106",
    agreedHours: "Tue-Sat 08:00-17:00",
    payType: "day-rate",
  },
];
...
const SUPPLIERS = [
  {
    name: "Wolseley Uxbridge",
    category: "merchant",
    contact_name: "Trade Counter",
    email: "uxbridge@wolseley.example",
    phone: "01895 410 221",
    notes: "Primary boiler and cylinder merchant for install jobs.",
  },
  {
    name: "City Plumbing Hayes",
    category: "merchant",
    contact_name: "Branch Desk",
    email: "hayes@cityplumbing.example",
    phone: "0208 845 4421",
    notes: "Used for plumbing consumables and same-day call-out parts.",
  },
  {
    name: "Vaillant Advance Spares",
    category: "manufacturer",
    contact_name: "Spare Parts Desk",
    email: "advance@vaillant.example",
    phone: "0345 602 2922",
    notes: "Preferred for repair parts and warranty installs.",
  },
  {
    name: "Grundfos Commercial Support",
    category: "manufacturer",
    contact_name: "Project Support",
    email: "support@grundfos.example",
    phone: "01525 850 000",
    notes: "Commercial pump and plantroom support.",
  },
  {
    name: "Stuart Turner Distribution",
    category: "manufacturer",
    contact_name: "Trade Support",
    email: "trade@stuartturner.example",
    phone: "0191 516 2002",
    notes: "Used for shower pumps and boosting solutions.",
  },
];

const PRODUCTS = [
  {
    supplier: "Wolseley Uxbridge",
    service: "boilers",
    category: "boiler",
    name: "Vaillant ecoTEC Plus 832 Combi",
    sku: "VAIL-832-COMBI",
    unit_cost: 1875,
    markup_percent: 29.33,
    sell_price: 2425,
  ...
  },
  {
    ...
    service: "boilers",
    category: "boiler",
    name: "Worcester 4000 30kW Combi",
    sku: "WORC-4000-30",
    unit_cost: 1695,
    markup_percent: 30.97,
    sell_price: 2220,
    vat_category: "standard_20",
  },
  {
    supplier: "City Plumbing Hayes",
    service: "power-flushing",
    category: "consumable",
    name: "Sentinel X800 Power Flush Pack",
    sku: "SENT-X800",
    unit_cost: 92,
    markup_percent: 57.61,
    sell_price: 145,
    vat_category: "standard_20",
  },
  {
    ...
    service: "plumbing",
    category: "controls",
    name: "Honeywell Home T6 Smart Thermostat",
    sku: "HONEY-T6",
    unit_cost: 118,
    markup_percent: 52.54,
    sell_price: 180,
    vat_category: "standard_20",
  },
  {
    ...
    service: "cylinders",
    category: "cylinder",
    name: "Heatrae Sadia Megaflo Eco 210i",
    sku: "MEGAFLO-210I",
    unit_cost: 940,
    markup_percent: 38.3,
    sell_price: 1300,
  ...
  {
    supplier: "Grundfos Commercial Support",
    service: "commercial-boilers",
    category: "pump",
    name: "Grundfos MAGNA3 32-120",
    sku: "MAGNA3-32120",
    unit_cost: 620,
    markup_percent: 33.87,
    sell_price: 830,
    vat_category: "standard_20",
  },
];
...
const SCENARIOS = [
  {
    customer: {
      ...
      site: {
        label: "Home",
        access_notes: "Ring doorbell. Toddler naps after lunch.",
        parking_notes: "Driveway on left, avoid blocking neighbour.",
      },
      asset: {
        service: "boilers",
        asset_type: "boiler",
        make: "Ideal",
        model: "Logic+ C30",
        serial_number: "IDEAL-HM-3021",
        install_date: daysAgo(6 * 365),
        service_due_date: daysFromToday(40),
        warranty_end_date: daysFromToday(420),
        notes: "Pressure drops overnight below 0.5 bar.",
      },
    },
    lead: {
      status: "booked",
      ...
      notes: [
        {
          ...
          body: "Job dispatched for first slot. Customer asked for engineer ETA by text.",
        },
        {
          author: "Empire Field Engineer",
          body: "On site. Pressure dropped to 0.4 bar. Expansion vessel and filling loop under review.",
        },
      ],
      photos: ["boiler-casing-before", "pressure-gauge-close-up", "filling-loop-layout"],
      hazards: [
        {
          title: "Tight cupboard access",
          description: "Cupboard is narrow and storage shelves limit movement around the boiler.",
          status: "active",
        },
      ],
      checklists: [
        {
          title: "Initial diagnostics complete",
          notes: "Need photos of pressure gauge and discharge pipework.",
          status: "required",
        },
      ],
  ...
  },
  {
    customer: {
      ...
      site: {
        label: "Home",
        access_notes: "Side gate is stiff. Customer works from home upstairs.",
      ...
      asset: {
        ...
        make: "Vaillant",
        model: "ecoTEC Pro 28",
        serial_number: "VAIL-PW-2218",
        install_date: daysAgo(7 * 365),
        service_due_date: daysFromToday(3),
        warranty_end_date: null,
        notes: "Annual service due and thermostat upgrade requested.",
      },
    },
    job: {
      ...
      notes: [
        {
          author: "Ben Carter",
          body: "Customer also wants a price to replace old thermostat with a smart controller while on site.",
        },
      ],
        ...
        versions: [
          {
            ...
            line_items: [
              { description: "Honeywell Home T6 Smart Thermostat supply and fit", qty: 1, unit_price: 180 },
            ],
          },
        ],
      },
  ...
  },
  {
    customer: {
      ...
      site: {
        label: "Home",
        access_notes: "Rear access through kitchen. Dog stays in lounge.",
        parking_notes: "Driveway fits one van.",
      },
      asset: {
        service: "boilers",
        asset_type: "boiler",
        make: "Worcester",
        model: "Greenstar Ri",
        serial_number: "WORC-FK-2009",
        install_date: daysAgo(15 * 365),
        service_due_date: null,
        warranty_end_date: null,
        notes: "Current heat-only boiler and cylinder due for full combi swap.",
      },
    },
    lead: {
      status: "accepted",
      ...
      notes:
        "Quote accepted and deposit paid. Customer resubmitted website form after booking to ask about flue boxing.",
      noteBodies: [
    ...
    job: {
      ...
      notes: [
        {
          author: "Claire Sutton",
          body: "Materials confirmed. Customer requested daily tidy-down and text on arrival.",
        },
        {
          author: "Ben Carter",
          body: "Quote revised to include boxed flue section and wireless thermostat.",
        },
      ],
      photos: ["old-heat-only-boiler", "existing-cylinder-cupboard", "flue-route-external"],
      phases: [
        {
          name: "Pre-start survey",
          description: "Measure flue route, confirm pipework alterations, confirm asbestos-free route.",
          status: "completed",
          sort_order: 1,
          targetOffsetDays: -2,
        ...
        },
        {
          ...
          description: "Boiler, filter, flue, and chemicals checked into van.",
          status: "ready",
          sort_order: 2,
          targetOffsetDays: 0,
        },
        {
          name: "Installation day one",
          description: "Remove old boiler and cylinder, run new condensate and gas line upgrades.",
          status: "planned",
          sort_order: 3,
          targetOffsetDays: 1,
        },
        {
          ...
          description: "Benchmark, controls handover, and customer demo.",
          status: "planned",
          sort_order: 4,
          targetOffsetDays: 2,
        },
      ...
      variations: [
        {
          title: "Additional boxed flue route",
          description: "Customer requested boxed section in utility room after survey.",
          estimated_value: 220,
          status: "approved",
        },
      ],
      hazards: [
        {
          title: "Loft hatch near flue route",
          description: "Use crawl boards if entering loft void to inspect final flue route.",
          status: "mitigated",
        },
        {
          title: "Heavy manual handling",
          description: "Old cylinder removal requires two-person lift and dust sheets on staircase.",
          status: "active",
        },
      ],
      checklists: [
        {
          title: "Pre-install photos captured",
          notes: "Before photos required for old appliance and flue route.",
          status: "completed",
          completedOffsetDays: -2,
        },
        {
          title: "Commissioning pack ready",
          notes: "Benchmark, warranty registration, and customer handover pack to be completed on day two.",
          status: "required",
        },
      ],
      certificates: [
        {
          title: "Gas Safe installation record",
          certificate_number: "GSI-260329-001",
          status: "draft",
          issuedOffsetDays: null,
          fileLabel: "gas-safe-installation-record",
        },
      ],
      quote: {
        documentType: "quote",
        ...
        schedules: [
          {
            ...
            payment_offsetDays: -1,
          },
          {
            label: "First install day",
            payment_type: "stage",
            percentage: 50,
            fixed_amount: null,
            due_offset_days: 1,
      ...
      purchaseOrders: [
        {
          ...
          status: "issued",
          total_amount: 2265,
          notes: "Boiler, flue, filter, and chemicals ordered for collection.",
          issuedOffsetDays: -1,
        },
      ],
      reconciliation: [
        {
          supplier: "Wolseley Uxbridge",
          entry_type: "invoice",
          reference_number: "WOL-UXB-12872",
          amount: 2265,
          status: "open",
        },
      ],
  ...
  },
  {
    customer: {
      ...
      site: {
        label: "Flat 2, 17 Fern Court",
        address_line1: "17 Fern Court, Flat 2",
        city: "Northolt",
        postcode: "UB5 5DP",
        access_notes: "Tenant will be home from 10:45.",
        parking_notes: "Visitor bays at rear.",
      },
      siteContact: {
        full_name: "Maya Brooks",
        phone: "07800 410 044",
        email: "maya.brooks@brookslettings.co.uk",
      ...
      asset: {
        ...
        make: "Baxi",
        model: "600 Combi",
        serial_number: "BAXI-DB-600",
        install_date: daysAgo(5 * 365),
        service_due_date: daysFromToday(1),
        warranty_end_date: daysFromToday(365),
        notes: "Tenant reports occasional banging from boiler casing.",
      },
    },
    job: {
      ...
      notes: [{ author: "Maria Ahmed", body: "Invoice to Brooks Lettings Ltd with PO reference BL-APR-17." }],
      photos: ["meter-position", "boiler-serial-label"],
      checklists: [
        {
          title: "Landlord cert paperwork pack",
          notes: "Tenant signature and meter reading required.",
          status: "required",
        },
      ],
      certificates: [
        {
          ...
          certificate_number: "CP12-260329-017",
          status: "draft",
          fileLabel: "cp12-record",
        },
      ],
    },
  },
  {
    customer: {
      ...
      site: {
        label: "Home",
        access_notes: "Garage side door unlocked for hose route.",
        parking_notes: "Wide driveway for van.",
      },
      asset: {
        service: "boilers",
        asset_type: "boiler",
        make: "Worcester",
        model: "CDi 29",
        serial_number: "WORC-SG-2911",
        install_date: daysAgo(12 * 365),
        service_due_date: daysFromToday(60),
        warranty_end_date: null,
        notes: "System slow to heat upstairs bedrooms.",
      },
    },
    job: {
      ...
      notes: [
        {
          author: "Claire Sutton",
          body: "Customer approved full flush package after survey and wants before/after temperature readings.",
        },
      ],
      ...
      hazards: [
        {
          ...
          description: "Power flush chemicals stored in garage. Gloves and eye protection required.",
          status: "active",
        },
      ],
      checklists: [
        {
          title: "Before and after radiator temperatures",
          notes: "Capture kitchen, lounge, and master bedroom readings.",
          status: "required",
        },
      ],
      quote: {
      ...
      purchaseOrders: [
        {
          ...
          status: "received",
          total_amount: 118,
          notes: "Chemicals and filter collected same morning.",
          issuedOffsetDays: 0,
        },
      ],
      reconciliation: [
  ...
  },
  {
    customer: {
      ...
      site: {
        label: "Home",
        access_notes: "Customer on site all day. Side entrance preferred for tools.",
        parking_notes: "Driveway space available.",
      },
      asset: {
        service: "cylinders",
        asset_type: "cylinder",
        make: "Telford",
        model: "Tempest 180",
        serial_number: "TELF-LF-180",
        install_date: daysAgo(14 * 365),
        service_due_date: null,
        warranty_end_date: null,
        notes: "Cylinder leaking from base and recovery is slow.",
      },
    },
    lead: {
      status: "booked",
    ...
    job: {
      ...
      notes: [
        {
          author: "Ben Carter",
          body: "Customer chose option including scale reducer due to local hard water.",
        },
      ],
      ...
      phases: [
        {
          name: "Strip out",
          description: "Drain and remove failed cylinder, prep discharge route.",
          status: "planned",
          sort_order: 1,
          targetOffsetDays: 3,
        },
        {
          name: "New cylinder install",
          description: "Fit cylinder, controls, and scale reducer. Fill and commission.",
          status: "planned",
          sort_order: 2,
          targetOffsetDays: 3,
        },
      ...
      hazards: [
        {
          title: "Hot water isolation",
          description: "Ensure supply isolated and discharge route verified before removal.",
          status: "active",
        },
      ],
      checklists: [
        {
          title: "Benchmark cylinder commissioning sheet",
          notes: "Record incoming pressure and expansion vessel charge.",
          status: "required",
        },
      ],
      certificates: [
        {
          title: "Unvented cylinder commissioning record",
          certificate_number: "UNV-260329-004",
          status: "draft",
          fileLabel: "unvented-commissioning-record",
        },
      ],
      quote: {
        documentType: "quote",
      ...
      purchaseOrders: [
        {
          ...
          status: "issued",
          total_amount: 1040,
          notes: "Cylinder and valve kit to collect at 07:30 on install day.",
          issuedOffsetDays: 2,
        },
      ],
      reconciliation: [
        {
          supplier: "Wolseley Uxbridge",
          entry_type: "invoice",
          reference_number: "WOL-UXB-12901",
          amount: 1040,
          status: "open",
        },
      ],
  ...
  },
  {
    customer: {
      ...
      site: {
        label: "Home",
        access_notes: "Meet customer at side gate for garden plant room discussion.",
        parking_notes: "Driveway fits two vans.",
      },
    },
    lead: {
  ...
  },
  {
    customer: {
      ...
      site: {
        label: "Home",
        access_notes: "Rear extension under construction. PPE required on entry.",
        parking_notes: "Permit scratch card under porch.",
      },
    },
    job: {
      ...
      notes: [
        {
          author: "Claire Sutton",
          body: "Builder wants wastes and shower valve position signed off before boarding walls.",
        },
      ],
      ...
      phases: [
        {
          name: "First fix",
          description: "Wastes, feeds, tray, and shower valve position.",
          status: "planned",
          sort_order: 1,
          targetOffsetDays: 5,
        },
        {
          name: "Second fix return",
          description: "Return after tiling for sanitaryware and brassware install.",
          status: "planned",
          sort_order: 2,
          targetOffsetDays: 11,
        },
  ...
  },
  {
    customer: {
      ...
      site: {
        label: "Practice Plant Room",
        access_notes: "Meet site manager at rear loading door.",
        parking_notes: "Commercial bay behind premises.",
      },
      siteContact: {
        full_name: "Nadia Ellis",
        phone: "07700 410 081",
        email: "nadia.ellis@oakridgedental.co.uk",
        role_label: "Facilities manager",
      },
    },
    lead: {
      status: "quoted",
      ...
      noteBodies: [
        "Warm commercial lead. Client wants phased replacement options to avoid surgery downtime.",
      ],
    },
    job: {
      ...
      notes: [
        {
          author: "Ben Carter",
          body: "Client asked for phased replacement costings with out-of-hours switchover options.",
        },
      ],
  ...
  },
  {
    customer: {
      ...
      site: {
        label: "Home",
        access_notes: "Alarm code to be provided morning of install.",
        parking_notes: "Driveway can take two vans.",
      },
      asset: {
        service: "boilers",
        asset_type: "boiler",
        make: "Ideal",
        model: "Mexico FF",
        serial_number: "IDEAL-EC-1998",
        install_date: daysAgo(28 * 365),
        service_due_date: null,
        warranty_end_date: null,
        notes: "Very old boiler due for full replacement.",
      },
    },
    job: {
      ...
      notes: [
        {
          author: "Maria Ahmed",
          body: "Finance application approved. Customer signed finance docs digitally.",
        },
      ],
      photos: ["old-back-boiler-cupboard", "loft-feed-and-expansion"],
      phases: [
        {
          name: "Strip out and pipe alterations",
          description: "Remove legacy boiler and prepare combi pipework.",
          status: "ready",
          sort_order: 1,
          targetOffsetDays: 7,
        },
        {
          name: "Install and commission",
          description: "Fit boiler, flue, and smart controls. Complete handover.",
          status: "planned",
          sort_order: 2,
          targetOffsetDays: 8,
        },
      ...
      purchaseOrders: [
        {
          ...
          status: "issued",
          total_amount: 2015,
          notes: "Worcester boiler and flue kit reserved for collection.",
          issuedOffsetDays: 6,
        },
      ],
      reconciliation: [
        {
          supplier: "Wolseley Uxbridge",
          entry_type: "invoice",
          reference_number: "WOL-UXB-12988",
          amount: 2015,
          status: "open",
        },
      ],
  ...
  },
  {
    customer: {
      ...
      site: {
        label: "Home",
        access_notes: "Parking behind block. Call on arrival for gate code.",
        parking_notes: "Use visitor bay 12.",
      },
      asset: {
        service: "cylinders",
        asset_type: "cylinder",
        make: "Megaflo",
        model: "Eco 170",
        serial_number: "MEGA-JM-170",
        install_date: daysAgo(4 * 365),
        service_due_date: daysFromToday(10),
        warranty_end_date: daysFromToday(730),
        notes: "Annual maintenance visit due.",
      },
    },
    job: {
      ...
      notes: [
        {
          author: "Claire Sutton",
          body: "Customer requested immersion check as hot water was slow after off-peak cycle.",
        },
      ],
      photos: ["cylinder-controls", "immersion-switch"],
      checklists: [
        {
          title: "Cylinder service checklist",
          notes: "Check expansion vessel pressure and tundish route.",
          status: "required",
        },
      ],
      certificates: [
        {
          title: "Cylinder service record",
          certificate_number: "CSR-260329-010",
          status: "draft",
          fileLabel: "cylinder-service-record",
        },
      ],
    },
  },
  {
    customer: {
      ...
      site: {
        label: "Home",
        access_notes: "Customer working from kitchen table. Keep water isolation updates clear.",
        parking_notes: "Street parking on opposite side after 10am.",
      },
    },
    job: {
      ...
      notes: [
        {
          author: "Amina Rahman",
          body: "Main stopcock seized. Replaced stopcock and remade compression joint under sink. System pressure stable after 30-minute test.",
        },
      ],
  ...
  },
  {
    customer: {
      ...
      site: {
        label: "14 Almond House",
        address_line1: "14 Almond House",
        city: "Hayes",
        postcode: "UB4 8QE",
        access_notes: "Caretaker opens meter cupboard at 08:15.",
        parking_notes: "Permit available from caretaker.",
      },
      siteContact: {
        full_name: "Rita Mistry",
        phone: "07800 410 099",
        email: "rita.mistry@stanmorelettings.co.uk",
        role_label: "Compliance coordinator",
      },
    },
    job: {
      ...
      notes: [
        {
          author: "Maria Ahmed",
          body: "Client wants one monthly consolidated invoice. Tag any remedial works separately.",
        },
      ],
      photos: ["meter-cupboard", "boiler-label-flat14"],
      checklists: [
        {
          title: "Portfolio cert pack",
          notes: "Record all tenant names and meter serials before leaving site.",
          status: "required",
        },
      ],
      certificates: [
        {
          title: "Portfolio CP12 record",
          certificate_number: "CP12-260329-114",
          status: "draft",
          fileLabel: "portfolio-cp12-record",
        },
      ],
    },
  },
  {
    customer: {
      ...
      site: {
        label: "Home",
        access_notes: "Estate agent meeting customer onsite for first visit.",
        parking_notes: "Driveway available.",
      },
    },
    lead: {
      status: "quoted",
  ...
  },
  {
    customer: {
      ...
      site: {
        label: "Home",
        access_notes: "Use back door if front porch is locked.",
        parking_notes: "Street parking unrestricted after 11am.",
      },
      asset: {
        service: "boilers",
        asset_type: "boiler",
        make: "Baxi",
        model: "EcoBlue 24",
        serial_number: "BAXI-RB-2405",
        install_date: daysAgo(3 * 365),
        service_due_date: daysFromToday(120),
        warranty_end_date: daysFromToday(540),
        notes: "Suspected diverter issue causing intermittent hot water at shower.",
      },
    },
    job: {
      ...
      notes: [
        {
          author: "Claire Sutton",
          body: "Customer says kitchen tap hot water is fine; shower cuts out after a minute.",
        },
      ],
  ...
  },
  {
    customer: {
      ...
      site: {
        label: "Home",
        access_notes: "Loose floorboards in landing. Watch step carrying tools upstairs.",
        parking_notes: "Street parking outside property.",
      },
    },
    job: {
      ...
      notes: [
        {
          author: "Ben Carter",
          body: "Customer has three small items: leaking WC inlet, dripping tap, and isolate outside tap for winter.",
        },
      ],
  ...
  },
  {
    customer: {
      ...
      site: {
        label: "Home",
        access_notes: "Top-floor flat with narrow stairs. Call on approach.",
        parking_notes: "Permit available from concierge.",
      },
    },
    lead: {
      status: "new",
  ...
  },
  {
    customer: {
      ...
      site: {
        label: "Home",
        access_notes: "Customer on night shifts. Prefers after-10am callback.",
        parking_notes: "Driveway clear after 10am.",
      },
    },
    lead: {
      status: "contacted",
  ...
  },
  {
    customer: {
      ...
      site: {
        label: "Flat 12",
        access_notes: "Flat buzzer 12. Please text before arrival.",
        parking_notes: "Pay-by-phone only.",
      },
    },
    lead: {
      status: "follow_up",
      ...
      noteBodies: [
        "Finance-focused lead. Sales to call with monthly repayment examples before booking survey.",
      ],
    },
  },
  {
    customer: {
      ...
      site: {
        label: "Managed Block A",
        address_line1: "Block A, 21 Kendal House",
        city: "Wembley",
        postcode: "HA9 8HZ",
        access_notes: "Meet site supervisor at loading bay.",
        parking_notes: "Trade bay behind shutter.",
      },
      siteContact: {
        full_name: "Mikael Jones",
        phone: "07800 410 188",
        email: "mikael.jones@harperestates.co.uk",
...
async function seedStaffCertifications(tenantId, staffMap) {
  ...
  const certifications = [
    {
      name: "Empire Field Engineer",
      title: "Gas Safe Registration",
      category: "qualification",
      issuer: "Gas Safe Register",
      issue_date: daysAgo(300),
      expiry_date: daysFromToday(65),
      reminder_days_before: 45,
      notes: "Domestic natural gas and LPG scope.",
    },
    {
      name: "Shaz Iqbal",
      title: "Unvented Hot Water",
      category: "training",
      issuer: "BPEC",
      issue_date: daysAgo(220),
      expiry_date: daysFromToday(420),
      reminder_days_before: 60,
      notes: "G3 compliant for unvented cylinder work.",
    },
    {
      name: "Luke Bennett",
    ...
    },
    {
      ...
      expiry_date: daysFromToday(520),
      reminder_days_before: 60,
      notes: "Approved for plumbing compliance inspections.",
    },
  ];
...
async function wipeTenantOperationalData(tenantId) {
  ...
  const [
    ...
    admin
      .schema("crm")
      .from("attachments")
      .select("file_url, entity_type, entity_id")
      .eq("tenant_id", tenantId),
...
async function createCustomerScenario({ tenantId, scenario, serviceMap, jobTypeMap, supplierMap, staffMap }) {
  ...
  if (scenario.lead) {
    ...
    const { data, error } = await admin
      ...
      .insert({
        ...
        submission_fingerprint: createHash("sha1")
          .update(`${scenario.customer.email}:${scenario.lead.source}:${scenario.lead.notes}`)
          .digest("hex"),
        ...
        matched_customer_confidence:
          scenario.lead.customer_match_result === "matched"
            ? "high"
            : scenario.lead.customer_match_result === "possible_duplicate"
              ? "low"
              : "new",
  ...
  if (scenario.job) {
    ...
    for (const checklist of scenario.job.checklists ?? []) {
      await admin
        ...
        .insert({
          ...
          completed_at:
            checklist.completedOffsetDays != null ? isoAtDay(checklist.completedOffsetDays, "17:00") : null,
        });
    }
    ...
    for (const phase of scenario.job.phases ?? []) {
      await admin
        ...
        .insert({
          ...
          completed_at:
            phase.completedOffsetDays != null ? isoAtDay(phase.completedOffsetDays, "16:30") : null,
        });
    }
    ...
    for (const certificate of scenario.job.certificates ?? []) {
      ...
      await admin
        ...
        .insert({
          ...
          issued_at:
            certificate.issuedOffsetDays != null ? daysFromToday(certificate.issuedOffsetDays) : null,
          file_url: fileUrl,
        });
    }
    ...
    if (scenario.job.quote) {
      const latestVersion = scenario.job.quote.versions.reduce(
        (current, version) => (version.version > current.version ? version : current),
        scenario.job.quote.versions[0],
      );
            ...
            .insert({
              ...
              paid_at:
                schedule.payment_status === "received"
                  ? isoAtDay(schedule.payment_offsetDays ?? schedule.due_offset_days, "12:00")
                  : null,
              is_demo: false,
              demo_scenario_key: null,
            })
          ...
          if (schedule.payment_status) {
            await admin
              ...
              .insert({
                ...
                notes:
                  schedule.payment_status === "received"
                    ? `${schedule.label} received by bank transfer.`
                    : `${schedule.label} invoice issued.`,
                is_demo: false,
                demo_scenario_key: null,
              });
          }
    ...
    for (const purchaseOrder of scenario.job.purchaseOrders ?? []) {
      ...
      const { data: poRow, error: poError } = await admin
        .schema("crm")
        ...
        .insert({
          ...
          issued_at:
            purchaseOrder.issuedOffsetDays != null ? daysFromToday(purchaseOrder.issuedOffsetDays) : null,
        })
        .select("*")
        .single();
      if (poError || !poRow) {
...
async function main() {
  ...
  for (const member of STAFF.filter(
    (entry) =>
      entry.email !== "admin@empirehomesolutions.local" &&
      entry.email !== "engineer@empirehomesolutions.local" &&
      entry.email !== "shaz@onlinebuzz.co.uk",
  )) {
