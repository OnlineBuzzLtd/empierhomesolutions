...
const bannerItems = [
  ...
  {
    key: "diagnostic",
    label: "Fixed diagnostic from £95 + VAT",
              ...
              <div className="grid items-stretch gap-0 lg:grid-cols-[0.8fr_1.2fr]">
                <div className="space-y-5 bg-[var(--ehs-panel)] p-4 sm:p-6 md:p-10">
                  ...
                  <p className="max-w-xl text-[15px] text-slate-700 md:text-xl">
                    Heating and Gas Engineers for urgent breakdowns, planned upgrades, domestic power
                    flushing, and trusted aftercare for homeowners and landlords.
                  </p>
